...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5545999448837:+55 45 99944-8837\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["5545999448837@s.whatsapp.net"] 
...
case 'lofi':
            ...
            case 'criador':
            case 'FALIDO':
                  client.sendMessage(from, {displayname: "FALIDO adm", vcard: vcard}, MessageType.contact, { quoted: mek})
